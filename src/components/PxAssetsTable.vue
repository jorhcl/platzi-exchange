    ...
    <thead>
      <tr class="bg-gray-100 border-b-2 border-gray-400">
        ...
        <td class="hidden sm:block">
          <input class="bg-gray-100 focus:outline-none border-b border-gray-400 py-2 px-4 block"
          id="filter"
          placeholder="Buscar"
          type="text"
          v-model="filter" />
...
export default {
  ...
  props: {   // define propiedades que vienen del padre
    assets: {  // nombre de la propiedad
      type: Array, // tipo de valor que recive
      default: () => [] // valores
    }
  },

  /// handler para el boton
  methods:{
    goToCoin(id){
